...
const STYLE = {
	...
	USERNAME_MAX_WIDTH: (RESOLUTION.CARD_WIDTH - ((RESOLUTION.CARD_WIDTH / 23.3333) * 4)) * 0.9,
	USERNAME_MAX_FONT_SIZE: 22.5 * SCALE,
	STATS_GRID_SHIFT: 18 * SCALE,
	STATS_GRID_GAP: 10 * SCALE,
	LABEL_ROLE_FONT_SIZE: 15.5 * SCALE,
    LABEL_STATS_PRIMARY_FONT_SIZE: (15.5 * SCALE) - 2,
    LABEL_STATS_SECONDARY_FONT_SIZE: (15.5 * SCALE) - 7,
}
